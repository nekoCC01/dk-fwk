import { createApp, defineComponent, h, hFragment } from '../../../packages/runtime/dist/fe-fwk.js'
...
const App = defineComponent({
  ...
  render() {
    return AppView(this.state, this.dispatch.bind(this))
  },

  dispatch(eventName, payload) {
    const reducer = reducers[eventName]
    this.updateState(reducer(this.state, payload))
  },
})
